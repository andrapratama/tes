...
class FPDF extends Component
{
	...
	protected $widths;
	protected $aligns;    // PDF version number
	protected $angle;
	public $nonheader;
	...
	function Header()
	{
		// return $this->Skip();exit;
		if ($this->nonheader) {
			$this->SetFont('Arial', 'I', 10);
			$this->Cell(276, 10, '', '', 1, 'P');
			$this->Ln(5);
		} else {
			// To be implemented in your own inherited class
			$this->SetFont('Arial', 'I', 7);
			$this->Cell($this->w - 20, 10, 'Dicetak dari: ', 'B', 1, 'P');
			$this->Ln(5);
		}
	}
	...
	function Footer()
	{
		if ($this->nonheader) {
			...
			$this->SetFont('Arial', 'BI', 10);
			// Page number
			$this->Cell(0, 10, 'Halaman ' . $this->PageNo() . '/' . $pagenumber, 0, 0, 'C');
		}
	}
